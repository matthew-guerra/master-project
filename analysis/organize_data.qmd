...
DATA$Ancestr1 <- factor(ifelse(DATA$Ancestr1<=260 | DATA$Ancestr1==800 |
                                 DATA$Ancestr1==803, "European",
                               ifelse(DATA$Ancestr1==900 | DATA$Ancestr1==902,
                                      "African-American",
                               ifelse(DATA$Ancestr1>=913 &
                                               DATA$Ancestr1<=923,
                                             "American Indian",
...
# Collapse Ancestr1 and Ancestr2 into 
