...
DATA <- read_fwf("data/data_raw/usa_00013.dat.gz",
         col_positions=fwf_positions(start=c(1,55,56,84,85,89,92,96,103,
                                             114,122,125),
                                    end=c(4,55,56,84,87,91,92,98,105,
                                          119,124,125),
                  col_names=c("Year","Metro","Homeland","Sex","Age","RaceD","Hispan",
                              "Ancestr1","Ancestr2","TribeD","EDUCD","QRace")),
...
DATA <- subset(DATA, select=c("Year","Metro","Homeland","Sex","Age","RaceD","Hispan",
                              "Ancestr1","Ancestr2","TribeD","EDUCD","QRace"))
DATA
```
...
# recode Tribe variable
DATA$Tribal_A <-factor(ifelse(DATA$TribeD==100300,
                              "Alaskan Athabaskan",
                              ifelse(DATA$TribeD==100400,"Aleut",
                              ifelse(DATA$TribeD==100510,"Inupiat",
                              ifelse(DATA$TribeD==100520, "Yup'ik",
                              ifelse(DATA$TribeD==100601, "Haida",
                              ifelse(DATA$TribeD==100603, "Tlingit-Haida",
                              ifelse(DATA$TribeD==100800, "AN,other",
                              ifelse(DATA$TribeD==200300, "Apache",
                              ifelse(DATA$TribeD==200800, "Blackfoot",
                              ifelse(DATA$TribeD==201900, "Cherokee",
                              ifelse(DATA$TribeD==202000, "Cheyenne",
                              ifelse(DATA$TribeD==202100, "Chicksaw",       
                              ifelse(DATA$TribeD==202300, "Chipepewa",
                              ifelse(DATA$TribeD==202500, "Choctaw",
                              ifelse(DATA$TribeD==202800, "Colville",
                              ifelse(DATA$TribeD==202900, "Comanche",
                              ifelse(DATA$TribeD==203500, "Creek",
                              ifelse(DATA$TribeD==203700, "Crow",
                              ifelse(DATA$TribeD==203800, "Delaware",
                              ifelse(DATA$TribeD==204600, "Iowa",
                              ifelse(DATA$TribeD==204700, "Iroquois",
                              ifelse(DATA$TribeD==205703, "Mexican American
                                     Indian",
                              ifelse(DATA$TribeD==205705, "South American
                                     Indian",
                              ifelse(DATA$TribeD==211000,"Sioux",NA))))))))))))
                              )))))))))))),
                       levels=c("Alaskan Athabaskan","Aleut","Inupiat","Yup'ik",
                                "Haida","Tlingit-Haida","AN, other","Apache",
                                "Blackfoot","Cherokee","Cheyenne","Sioux")
)
table(DATA$TribeD,DATA$Tribal_A, exclude = NULL)
```
