...
DATA$Tribal_A <- factor(
  unname(tribe_labels[as.character(DATA$TribeD)]),
  levels = unname(tribe_labels)
)
...
```{r}
#recode rancestry2 into big racial categories
DATA <- DATA %>%
  mutate(
