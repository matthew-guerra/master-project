...
#need to fix PI category (Native Hawaiian)
...
DATA$RaceC <- factor(DATA$RaceC, levels = c("White", "Black", "AIAN", "Asian", "Pacific Islander", "White and AIAN","Black and AIAN","AIAN and Asian"))
```
