...
DATA$RaceC <- factor(ifelse(DATA$RaceD == 100, "White",
                  ...
                  ifelse(DATA$RaceD %in% c(802,906,907), "White and Indigenous",
                  ifelse(DATA$RaceD %in% c(830,931,932), "Black and Indigenous",
                  ifelse(DATA$RaceD %in% c(851,852,853,854,940,941),
