...
DATA$RaceC <- factor(DATA$RaceC, levels = c("White", "Black", "Indigenous", "Pacific Islander","Other", "Asian", "White and Indigenous","Black and Indigenous","Asian and Indigenous"))
```
