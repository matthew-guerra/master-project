...
asian_alone <- c(400,410,420,500,600,610,620,640,641,642,643,651,660,661,662,
                 ...
                 678,679) # figure out
consistent_wi <- c(802,901,905,906,907,916,950,951,960,961,980,981,982,984) #needs more
consistent_bi <- c(830,901,930,931,950,951,970,971,972,980,981,982,985)
consistent_ai <- c(850,851,853,854,905,916,930,940,941,950,960,961,970,971,974,
                   975,980,981,984,985)
...
DATA$RaceC <- factor(ifelse(DATA$RaceD == 100, "White",
                  ...
                  ifelse(DATA$RaceD %in% c(802,906,907,962), "White and Indigenous",
                  ifelse(DATA$RaceD %in% c(830,931,932,972), "Black and Indigenous",
                  ifelse(DATA$RaceD %in% c(851,852,853,854,940,941,974,975),
                         "Asian and Indigenous",
                  ifelse(DATA$RaceD %in% c(901,905,916,930,950, 951, 960,961,
                                           962, 970,971,972,974,975, 980,981,
                                           982,984,985,986), "3+ Races",
                         NA)))))))))))
