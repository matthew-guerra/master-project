...
On January 1, 1952, the Bureau of Indian Affairs (BIA) launched the Voluntary Relocation Program, and established field offices in Chicago, Salt Lake City, Denver, San Francisco, San Jose, Los Angeles, Oakland, Portland, Dallas, Tulsa, Oklahoma, St. Louis, Minneapolis, Cincinnati, Cleveland, and Joliet and Waukegan, Illinois (Kent-Stoll 2024). The program was advertised as a pathway to economic stability, promising Indigenous Americans better employment opportunities, improved housing, and an overal better quality of life if they decided to leave their rural reservations for urban centers (Rosenthal 2012). However, beneath the promise for a better life was the federal agenda of assimilation, which sought to sever the connection between indigenous people  from their homelands, cultures, and tribal affiliation in favor of integration into mainstream society. 

In 1956, the federal government reinforced these assimilationists policies with the passage of the Indian Relocation Act (Public Law 949), which initiated a new program, the Adult Vocational Training program. This program offered housing assistance, vocational training, and job placement services under the BIA. The selection process for the AVT program is meticulous since if the US government was going to pay for Indigenous Americans to gain an education and vocational skills, they wanted to “identify the applicants with the greatest potential for making a clean break from the reservation and assimilating into the city” (Rosenthal 2012: 53). This exmplemfies how the VRP and the AVT programs not only were meant to serve as economic initiatives but were also deeply rooted in federal policies that were designed to erode Indigenous identity and community ties. 

Despite these efforts, the relocation of thousands of Indigenous individuals to urban centers led to the emergence of new forms of Indigenous identity and political consciousness. In many cities, relocated individuals found themselves in shared experiences of marginalization and cultural dislocation, leading to the development of intertribal and pan-Indian identities. These urban Indigenous communities established organizations focused on mutual aid, social services, education, and political activism. It was within these very spaces that the Red Power Movement gained momentum, ultimately giving rise to the American Indian Movement (AIM). In response to systemic anti-Indigenous policies, discrimination, and police violence, Indigenous activists mobilized, advocating for self-determination, tribal sovereignty, and Indigenous rights on a national scale (Kent-Stoll 2024).
...
In 2010 Liebler published an article that argued that “homelands — physical places with cultural meaning — are an important component of the intergenerational transfer of a single-race identity in indigenous mixed-race families” (IPUMS USA: Descr: HOMELAND, n.d.; Liebler 2010:596). To test this hypothesis she estimated logistic regression models predicting the likelihood of a child being reported as a single-race American Indian. Her models aacounted for several factors including the racial composition of the local area, geographic isolation, family and area poverty levels, and ties to other American Indians or other people. Liebler concluded that the variable's predictive power can be attributed to the history and cultural signifigance of Indigenous homelands.

While this explanation is compelling, the history of both forced and voluntary Indigenous relocation complicates the relationship between homelands and racial identity. Given the widespread displacement of Indigenous peoples, racial scholars must critically assess whether the homeland variable remains a reliable predictor of Indigenous identity across different contexts. For instance, could rurality itself be influencing the predictive power of the homeland variable, rather than the cultural significance of the homeland? Additionally, does the homeland variable hold predictive power for racial identification among multiracial Indigenous adults, or is its use primarily limited to illuminating how monoracial parents navigate their multiracial children’s racial identity? These questions highlight the need for further research into the intersections of place, race, and identity, particularly in the context of multiracial Indigenous individuals.
...
Age as a predictor variable demonstrated significant yet minimal effects on racial response. Among respondents with White and Indigenous ancestry it was observed that for every year in age, there was a minimal increase in the likelihood for respondents to identify as Indigenous rather than White by 0.002%, and as Multiracial rather than White by 0.001% For those with Black and Indigneous ancestry, every increase in age was associated with a 0.003% decrease in the likelihood a respondent would identify as multiracial rather than Black. There was a similar trend with respindents with both Asian and Indigneous ancestry as for every increase in age there was a 0.01% increase in the likelihood a respondent would identify as Indigenous alone versus Asian.
