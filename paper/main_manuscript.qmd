...
To analyze the race reporting of individuals with multiracial Indigenous ancestry, the write-in ancestries from the ancestry question were used. To accomplish this the responses were “racialized’ in the same fashion as done by Gullickson & Morning @gullickson2011. Although the free response nature allows respondents to be quite detailed in their responses, they are not always consistent with Census racial options, which is evident with the over 500 unique responses to the ancestry question. To make this number more manageable, racial ancestries were recoded to align with the Office of Management and Budget’s (OMB) different race categories, which include white, black, American Indian or Alaskan Native, Asian, and Pacific Islander [@bureauTopicRace].
