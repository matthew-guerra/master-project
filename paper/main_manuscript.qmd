...
\
After reviewing all three tables, being of Hispanic or Latino origin emerges as a significant predictor of identifying as Indigenous alone. This finding although unexpected aligns with some research that has the potential to shape multiracial Indigenous identity. For example, the Latinization of Indigenous individuals is a body of work that details how, particularly within institutional settings like the education system, identity can be administratively reshaped via record changes going from Indigenous to being classified as Latino only.
...
Across all groups, the models suggest that Homeland status, rather than rural residence alone, is crucial for strengthening Indigenous-alone identity. Additionally, the unexpected prominence of Hispanic or Latino origin as a predictor of Indigenous-alone identity aligns with research on the Latinization of Indigenous individuals, particularly within institutional contexts. Notably, Asian/Indigenous respondents exhibited high levels of multiracial identification, indicating the need for further research into the factors influencing multiracial identity within this group. Overall, these findings underscore the importance of Homeland connections in shaping Indigenous identity across diverse racial ancestries and ages.
