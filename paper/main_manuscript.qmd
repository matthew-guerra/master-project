...
In 2010 Liebler published an article that argued that “homelands — physical places with cultural meaning — are an important component of the intergenerational transfer of a single-race identity in indigenous mixed-race families” @noauthor_ipums_nodate; @liebler_homelands_2010 [p. 596]. To test this hypothesis she estimated logistic regression models predicting the likelihood of a child being reported as a single-race American Indian. Her models aacounted for several factors including the racial composition of the local area, geographic isolation, family and area poverty levels, and ties to other American Indians or other people. Liebler concluded that the variable's predictive power can be attributed to the history and cultural signifigance of Indigenous homelands.
